...
<div class="flex items-end justify-between w-full pt-20">
    <p class="lg:text-9xl pt-[30vh] pb-20 w-min">Amal Yakubov</p>
    <div>
...
<p class="text-3xl pt-8 min-w-3xl w-min font-medium leading-9.5">
    ...
    girl who likes cool stuff and building really cool stuff. <br /> <br /> Based
    in the best city of Europe: Warsaw, Poland.
</p>
