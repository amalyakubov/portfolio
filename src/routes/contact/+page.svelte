<div class="flex flex-1 flex-col justify-between">
    <form
        class="bg-[#ffff] px-12 py-10 flex flex-col max-w-3xl"
        id="contact_form"
    >
        <div class="flex flex-row">
            ...
            <input
                ...
                class="outline-none max-w-full px-2 py-4 placeholder:text-black/70 text-black/70"
            />
        </div>
        <div class="flex flex-row">
            <label
        ...
        <div>
            <button
                form="contact_form"
                title="Submit"
                class=" underline underline-offset-7 w-max decoration-2 text-black text-md"
                >Send ‎ ‎‎ ‎ ‎ ‎ ‎ ‎ ‎‎ ‎
            </button>
        </div>
    </form>
